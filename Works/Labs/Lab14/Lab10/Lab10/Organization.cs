...
namespace Lab10
{
    ...
    public class Organization : IInterface
    {
        ...
        {
            Console.WriteLine($"Название организации - {Name}. Город - {City}. Количество сотрудников - {Employees}");
        }

        [ExcludeFromCodeCoverage]
        public override string ToString()
        {
            return ($"Название организации - {Name}. Город - {City}. Количество сотрудников - {Employees}");
        }
        ...
        public static Organization RandomOrganization(int start, int end)
        {
            Organization org = null;
            int type = rnd.Next(start, end);
